...
KNOWN_WRONG = {
    ...
    ("302968", "필기일정"),    # 9/5가 정답인데 8/31을 가져온다 (글자가 두 번 찍힌 표)
    ("302968", "면접일정"),
}
