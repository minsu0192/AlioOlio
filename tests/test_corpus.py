...
POSTINGS = {
    ...
    "303653": (date(2026, 8, 8), "한국광해광업공단"),
    "303652": (date(2026, 8, 7), "한국보훈복지의료공단(정형외과)"),
    "303651": (date(2026, 8, 7), "한국보훈복지의료공단(임상병리)"),
    "303650": (date(2026, 8, 7), "한국기술교육대학교"),
    "303648": (date(2026, 8, 7), "경북대학교병원"),
    "303647": (date(2026, 8, 7), "한국의료분쟁조정중재원"),
    "303646": (date(2026, 8, 7), "서울대학교치과병원"),
    "303645": (date(2026, 8, 7), "근로복지공단(순천병원)"),
    "303643": (date(2026, 8, 7), "전남대학교병원(대체자)"),
    "303641": (date(2026, 8, 7), "대한적십자사"),
}
...
CONFIRMED = {
    ...
    "303653": {"서류발표일": "2026-09-01", "필기일정": "2026-09-06", "필기발표일": "2026-09-11",
               "면접일정": "2026-09-17", "최종발표일": "2026-10-02"},
    "303652": {"면접일정": "2026-08-20"},
    "303651": {"면접일정": "2026-08-21"},
    "303650": {"면접일정": "2026-08-26"},
    "303647": {"최종발표일": "2026-09-30"},
    "303645": {"면접일정": "2026-08-20", "최종발표일": "2026-08-27"},
    # 날짜 없이 "8월 4주차~9월 1주차"처럼 주차로만 적은 공고. 못 뽑는 것이 정답이다.
    "303574": {},
    # 전형방법만 적고 날짜는 없는 공고.
    "303648": {},
    # 단계 이름을 한 줄에, 날짜를 다른 줄에 적는 HWP. 어느 날짜가 어느 단계인지
    # 붙일 방법이 없다(최종발표는 9.1.). 틀린 값을 쓰느니 비운다.
    "303643": {},
    "303646": {},
    # 공고문이 이미지(jpg)라 글자가 없다.
    "303641": {},
